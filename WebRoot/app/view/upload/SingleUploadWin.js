Ext.define('KJXM.view.upload.SingleUploadWin', {
	extend : 'KJXM.view.KjWindow',
	layout:'fit',
	width:360,
	//height:150,
	fileModel:'undefined',//维修加固一户一档
	xmmc:'undefined',//xmmc+hbh
	lx:'undefined',//维修加固项目信息图片
	autoHeight : true,
	modal : true,
	frame : true,
	border : false,
		...
		var impForm = Ext.create('Ext.form.Panel',{
			...
			buttons : [ {
				...
				handler : function() {
					...
					efurl = impForm.getComponent('uploadE').getValue();
					...
					if (type != 'jpg'&&type != 'png'&&type != 'gif') {
						Ext.Msg.alert("提示", "仅支持上传jpg、png、gif格式的图片");
						return;
					}
					...
					impForm.form.submit({
						url : 'fileDataImp.action',
						params: {
							 "model" : window.fileModel,
				             "xmmc":window.xmmc,
				             "lx":window.lx
					    },
						waitMsg : '正在处理......',
